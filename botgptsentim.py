    ...
    def analyze(self, image_path: str, sentiment_df: pd.DataFrame, ticker: str, metrics: dict) -> str:
        try:
            ...
            if sentiment_df.empty:
                ...
                sentiment_text += sentiment_df[-10:][['Date and time', 'score']].to_string(index=False)
            ...
            prompt = (
                ...
                f"Before filling the template, provide a brief description of the chart for the required company in your own words (2-3 sentences) "
